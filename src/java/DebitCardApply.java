 ...
 * @author Avdesh Tyagi
 */
public class DebitCardApply extends HttpServlet {
    ...
    pstmt.setLong(2,y);
    pstmt.setString(3, "NEW DEBIT CARD REQUEST");
   // pstmt.setLong(4,0);
   // pstmt.setLong(5,0);
    //pstmt.setLong(6,0);
    ...
    String  sq2 = "SELECT email FROM Account1" +
      ...
      while(rs.next()){
         ...
         email1=rs.getString("email");
           ...
           RequestDispatcher rd1=request.getRequestDispatcher("./succdcapp.html");
                  ...
                  else
                  {
                        ...
                        RequestDispatcher rd2=request.getRequestDispatcher("./invalidpassdcapp.html");
           ...
           /* out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DebitCardApply</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DebitCardApply at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
