...
public class Moneytransfer extends HttpServlet {
    ...
    pstmt.setString(5,"fund received from Account No."+ y);
         pstmt.setString(6,"CASH RECEIVED");
    pstmt.executeUpdate();
    ...
    String  sq2 = "SELECT email FROM Account1" +
      ...
      while(rs.next()){
         ...
         email1=rs.getString("email");
           ...
           RequestDispatcher rd1=request.getRequestDispatcher("./succmt.html");
                        rd1.include(request,response);  
        
        }
       else{
            
            RequestDispatcher rd5=request.getRequestDispatcher("./insufficientmt.html");
                  ...
                  else
                  {
                        ...
                        RequestDispatcher rd2=request.getRequestDispatcher("./unsuccmoneytransfer.html");
