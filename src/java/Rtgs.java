 ...
 * @author Avdesh Tyagi
 */
public class Rtgs extends HttpServlet {
             ...
             PreparedStatement ps=con.prepareStatement("select * from Account1 where acno=? and password=? ");
                  ...
                  if(rs.next())
                  {
                      ...
                      if(x<199999){
                           ...
                           RequestDispatcher rd11=request.getRequestDispatcher("./invalidamountrtgs.html");
    ...
    pstmt.setString(5,"fund received from Account No."+ y);
         pstmt.setString(6,"RTGS RECEIVED");
    pstmt.executeUpdate();
    ...
    String  sq2 = "SELECT email FROM Account1" +
      ...
      while(rs.next()){
         ...
         email1=rs.getString("email");
           ...
           RequestDispatcher rd1=request.getRequestDispatcher("./succrtgs.html");
            ...
            RequestDispatcher rd5=request.getRequestDispatcher("./unsufficientfund.html");
                  ...
                  else
                  {
                        ...
                        RequestDispatcher rd2=request.getRequestDispatcher("./unsuccrtgs.html");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Rtgs</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Rtgs at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
