 ...
 * @author Avdesh Tyagi
 */
public class CreditCardApply extends HttpServlet {
    ...
    pstmt.setLong(2,y);
    pstmt.setString(3, "NEW CREDIT CARD REQUEST");
    ...
    String  sq2 = "SELECT email FROM Account1" +
      ...
      while(rs.next()){
         ...
         email1=rs.getString("email");
           ...
           RequestDispatcher rd1=request.getRequestDispatcher("./succccapp.html");
                  ...
                  else
                  {
                        ...
                        RequestDispatcher rd2=request.getRequestDispatcher("./invalidpassccapp.html");
           ...
           /* out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CreditCardApply</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CreditCardApply at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");*/
        }
    }
