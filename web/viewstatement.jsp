<%-- 
    ...
    Created on : 25 Feb, 2016, 11:49:12 PM
    Author     : Avdesh Tyagi
--%>
 ...
 <%@ page import = "java.sql.*" %>
  ...
  //ResultSet rs = 
        ...
        //PreparedStatement ps=con.prepareStatement("select balance from Account1 where password=? ");
            PreparedStatement ps=con.prepareStatement("select drcr,amount,specification,type,date2 from statementtable where acno=? order by date2 desc");
                  ps.setLong(1, acnu);
